...
function initFluidCursor() {
  ...
  function initFramebuffers() {
    ...
    dye = createDoubleFBO(dyeRes.width, dyeRes.height, ext.formatRGBA, gl.RGBA, ext.halfFloatTexType, gl.LINEAR);
    velocity = createDoubleFBO(simRes.width, simRes.height, ext.formatRG, gl.RG, ext.halfFloatTexType, gl.LINEAR);
  }
...
//     }
    ...
    // const sectionChangeColor = document.querySelector('.colorsectionjs');

    // sectionChangeColor.addEventListener('scroll', function() {
    //     const scrollTop = sectionChangeColor.scrollY;
    ...
    //     } else {
    //         // Scrolling up
    //         section.style.backgroundColor = 'lightblue'; // Change to your normal color
    //     }
